...
const conversation = new watson.ConversationV1({
    username: '5329ed69-5967-4068-a38b-01b20cc458c7',
    password: 'EJdnRg8BKAiX',
...
const message = function (text, context) {
    const payload = {
        workspace_id: process.env.WORKSPACE_ID || 'a6860673-457f-4942-a949-04c303829484',
        input: {
            text: text
        },
        context: context
...
message('turn on AC', undefined)
    .then(response1 => {
        ...
        return message('turn on wipers and heater', response1.context);
    })
    .then(response2 => {
